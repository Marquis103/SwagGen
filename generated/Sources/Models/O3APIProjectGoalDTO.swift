...
public class O3APIProjectGoalDTO: APIModel {
    ...
    public init(actualFinishDate: DateTime? = nil, actualStartDate: DateTime? = nil, categoryID: Int? = nil, description: String? = nil, focusID: Int? = nil, id: Int? = nil, name: String? = nil, plannedFinishDate: DateTime? = nil, plannedStartDate: DateTime? = nil, progress: Int? = nil, projectID: Int? = nil, statusID: Int? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? O3APIProjectGoalDTO else { return false }
    ...
    public static func == (lhs: O3APIProjectGoalDTO, rhs: O3APIProjectGoalDTO) -> Bool {
