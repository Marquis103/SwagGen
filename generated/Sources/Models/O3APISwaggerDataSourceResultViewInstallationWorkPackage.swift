...
public class O3APISwaggerDataSourceResultViewInstallationWorkPackage: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? O3APISwaggerDataSourceResultViewInstallationWorkPackage else { return false }
    ...
    public static func == (lhs: O3APISwaggerDataSourceResultViewInstallationWorkPackage, rhs: O3APISwaggerDataSourceResultViewInstallationWorkPackage) -> Bool {
