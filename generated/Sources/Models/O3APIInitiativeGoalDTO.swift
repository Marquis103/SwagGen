...
public class O3APIInitiativeGoalDTO: APIModel {
    ...
    public init(actualFinishDate: DateTime? = nil, actualStartDate: DateTime? = nil, categoryID: Int? = nil, description: String? = nil, focusID: Int? = nil, id: Int? = nil, initiativeID: Int? = nil, name: String? = nil, plannedFinishDate: DateTime? = nil, plannedStartDate: DateTime? = nil, progress: Int? = nil, statusID: Int? = nil) {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? O3APIInitiativeGoalDTO else { return false }
    ...
    public static func == (lhs: O3APIInitiativeGoalDTO, rhs: O3APIInitiativeGoalDTO) -> Bool {
