...
public class O3APIFilterGroup: APIModel {
    ...
    public func isEqual(to object: Any?) -> Bool {
      guard let object = object as? O3APIFilterGroup else { return false }
    ...
    public static func == (lhs: O3APIFilterGroup, rhs: O3APIFilterGroup) -> Bool {
