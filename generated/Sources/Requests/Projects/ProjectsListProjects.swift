...
extension O3API.Projects {

    /**
    Project List

    This method returns a list of projects for current authenticated user.
    */
    public enum ProjectsListProjects {

        public static let service = APIService<Response>(id: "Projects_ListProjects", tag: "Projects", method: "GET", path: "/api/projects/apilist", hasBody: false, securityRequirements: [])

        public final class Request: APIRequest<Response> {

            public init() {
                super.init(service: ProjectsListProjects.service)
            }
        }
